...
(def translations
  {:en
   {:app-title "Wizmetria"
    ...
    :footer-text "© 2025 Wizmetric Arcanum Squad • Revealing the Mystical Patterns of Alphabetical Symmetry"
   ...
   {:app-title "Визметрия"
    ...
    :footer-text "© 2025 Отряд Визметрического Арканума • Раскрытие мистических образов алфавитной симметрии"
   ...
   {:app-title "符文度量"
    ...
    :footer-text "© 2025 魔术测量奥义小队 • 揭示字母对称的神秘图案"
   ...
   {:app-title "ويزمتريا"
    ...
    :footer-text "© 2025 فريق ويزمتريك الغامضة • الكشف عن الأنماط الغامضة للتماثل الأبجدي"
   ...
   {:app-title "ויזמטריה"
    ...
    :footer-text "© 2025 צוות וויזמטריק הסודי • חשיפת התבניות המיסטיות של סימטריה אלפביתית"
   ...
   {:app-title "위즈메트리아"
    ...
    :footer-text "© 2025 위즈메트릭 비의 부대 • 알파벳 대칭의 신비로운 패턴 탐구"
   ...
   {:app-title "விஸ்மெட்ரியா"
    ...
    :footer-text "© 2025 விஸ்மெட்ரிக் ரகசிய குழு • எழுத்து சமச்சீரின் மர்ம வடிவங்களை வெளிப்படுத்துதல்"
