...
(def translations
  {:en
   ...
   {:app-title "위즈메트리아"
    ...
    :text-analysis-description "원형 대칭을 가진 단어를 찾기 위해 텍스트 파일을 업로드하세요."
    :upload-button "파일 업로드"
    ...
    :footer-text "© 2025 아르카눔 위즈메트릭스 언리미티드 • 원형 대칭을 통한 패턴 조명"
   ...
   {:app-title "விஸ்மெட்ரியா"
    ...
    :text-analysis-description "வட்ட சமச்சீருடன் கூடிய சொற்களைக் கண்டறிய உரை கோப்பைப் பதிவேற்றவும்."
    :upload-button "கோப்பை பதிவேற்று"
    ...
    :footer-text "© 2025 ஆர்கானம் விஸ்மெட்ரிக்ஸ் அன்லிமிடெட் • வட்ட சமச்சீர் மூலம் முறைகளை வெளிப்படுத்துதல்"
