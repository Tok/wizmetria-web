...
var i_14710 = (self__.level + (1));
while(true){
if((i_14710 <= (new_level + (1)))){
(update[i_14710] = self__.header);

var G__14712 = (i_14710 + (1));
i_14710 = G__14712;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14713 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14713[i]));
} else {
x__$2.forward.push((((i < links_14713.length))?(links_14713[i]):null));
}

if((i < links_14713.length)){
(links_14713[i] = x__$2);
} else {
links_14713.push(x__$2);
}
...
var i_14717 = (0);
while(true){
if((i_14717 <= self__.level)){
var links_14718 = (update[i_14717]).forward;
if((x__$1 === (((i_14717 < links_14718.length))?(links_14718[i_14717]):null))){
(links_14718[i_14717] = (x__$1.forward[i_14717]));

var G__14719 = (i_14717 + (1));
i_14717 = G__14719;
continue;
} else {
var G__14721 = (i_14717 + (1));
i_14717 = G__14721;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__14738 = nx;
var G__14739 = (level__$1 - (1));
x = G__14738;
level__$1 = G__14739;
continue;
} else {
var G__14741 = x;
var G__14742 = (level__$1 - (1));
x = G__14741;
level__$1 = G__14742;
continue;
}
