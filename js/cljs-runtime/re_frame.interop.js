...
return [(function (){var pred__19734 = cljs.core.instance_QMARK_;
var expr__19735 = reactive_val;
if(cljs.core.truth_((pred__19734.cljs$core$IFn$_invoke$arity$2 ? pred__19734.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__19735) : pred__19734.call(null, reagent.ratom.RAtom,expr__19735)))){
return "ra";
} else {
if(cljs.core.truth_((pred__19734.cljs$core$IFn$_invoke$arity$2 ? pred__19734.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__19735) : pred__19734.call(null, reagent.ratom.RCursor,expr__19735)))){
return "rc";
} else {
if(cljs.core.truth_((pred__19734.cljs$core$IFn$_invoke$arity$2 ? pred__19734.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__19735) : pred__19734.call(null, reagent.ratom.Reaction,expr__19735)))){
return "rx";
} else {
if(cljs.core.truth_((pred__19734.cljs$core$IFn$_invoke$arity$2 ? pred__19734.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__19735) : pred__19734.call(null, reagent.ratom.Track,expr__19735)))){
return "tr";
} else {
return "other";
}
