...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11716 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11716(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_11724 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_11724(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_11726 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_11726(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_11736 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_11736(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11763 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11763(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11769 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11769(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__11708,callback){
var map__11710 = p__11708;
var map__11710__$1 = cljs.core.__destructure_map(map__11710);
var input = map__11710__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11710__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11710__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
