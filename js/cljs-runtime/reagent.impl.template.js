...
var G__18504 = o;
reagent.impl.template.goog$module$goog$object.set(G__18504,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__19007__delegate = function (args){
...
return G__19007__delegate.call(this,args);};
...
return G__19007__delegate(args);
});
...
var G__18528 = o;
reagent.impl.template.goog$module$goog$object.set(G__18528,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__19023.cljs$lang$applyTo = (function (arglist__19031){
...
var G__18536 = props;
var G__18536__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18536,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18536);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18536__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__18570 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18570,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__18570;
}
})(),id_class);
...
var temp__5804__auto___19040 = (function (){var and__5000__auto__ = js_props;
...
if(cljs.core.truth_(temp__5804__auto___19040)){
var d_19042 = temp__5804__auto___19040;
if((d_19042 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_19042.s}));
} else {
...
var G__18613 = (cljs.core.count(argv) - first_child);
switch (G__18613) {
case (0):
...
var vec__18625 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18625,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18625,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18625,(2),null);
...
var temp__5808__auto___19088 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___19091 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19091 == null)){
} else {
var key_19092 = temp__5808__auto___19091;
...
var temp__5808__auto___19101 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___19101 == null)){
} else {
var key_19103 = temp__5808__auto___19101;
(jsprops.key = key_19103);
}
...
var temp__5808__auto___19123 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19123 == null)){
} else {
var key_19125 = temp__5808__auto___19123;
(jsprops.key = key_19125);
}
...
var temp__5808__auto___19127 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19127 == null)){
} else {
var key_19128 = temp__5808__auto___19127;
(jsprops.key = key_19128);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18764_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__18764_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__18780 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18780,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18780,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template18925 = (function (opts,id,fn_to_element,parse_fn,meta18926){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template18925.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18927,meta18926__$1){
var self__ = this;
var _18927__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template18925(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta18926__$1));
}));

(reagent.impl.template.t_reagent$impl$template18925.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18927){
var self__ = this;
var _18927__$1 = this;
return self__.meta18926;
}));

(reagent.impl.template.t_reagent$impl$template18925.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template18925.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template18925.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template18925.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template18925.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template18925.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta18926","meta18926",-273136538,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template18925.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template18925.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template18925");

(reagent.impl.template.t_reagent$impl$template18925.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template18925");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template18925.
 */
reagent.impl.template.__GT_t_reagent$impl$template18925 = (function reagent$impl$template$__GT_t_reagent$impl$template18925(opts,id,fn_to_element,parse_fn,meta18926){
return (new reagent.impl.template.t_reagent$impl$template18925(opts,id,fn_to_element,parse_fn,meta18926));
});
...
return (new reagent.impl.template.t_reagent$impl$template18925(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
