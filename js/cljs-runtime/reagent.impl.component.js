...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__17842 = c;
var G__17842__$1 = (((G__17842 == null))?null:G__17842.prototype);
if((G__17842__$1 == null)){
return null;
} else {
return G__17842__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__17846 = c;
var G__17846__$1 = (((G__17846 == null))?null:G__17846.prototype);
if((G__17846__$1 == null)){
return null;
} else {
return G__17846__$1.render;
}
})() == null)))));
});
...
G__18376.cljs$lang$applyTo = (function (arglist__18380){
...
var or__5002__auto__ = (function (){var G__17924 = c;
var G__17924__$1 = (((G__17924 == null))?null:G__17924.constructor);
if((G__17924__$1 == null)){
return null;
} else {
return G__17924__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__17945 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__17946 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__17946);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__17945);
}});
...
var c = this;
var G__18036_18397 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__18036_18397 == null)){
} else {
reagent.ratom.dispose_BANG_(G__18036_18397);
}
...
var renders_18399 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_18400 = cljs.core.first(cljs.core.vals(renders_18399));
...
if((cljs.core.count(renders_18399) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_18399))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_18400)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_18400], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__18213 = o;
reagent.impl.component.goog$module$goog$object.set(G__18213,cljs.core.name(k),v);
...
while (G__18445__i < G__18445__a.length) {G__18445__a[G__18445__i] = arguments[G__18445__i + 0]; ++G__18445__i;}
  args = new cljs.core.IndexedSeq(G__18445__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__18298 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__18299 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__18299);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__18298);
}});
...
var vec__18329 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18329,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18329,(1),null);
...
var G__18341 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__18341 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__18341);
}
});
}),[]);
